...
<head>
	...
	<div id="headerStyleType" class="zap_helper_div">style3</div>
					...
					<div class="logo columns" style="margin-top: 10px; margin-left: 0px;">
						<h1>
							<a href="index.html" tabindex="-1">
								<!-- LOGO -->	
								<img class="logo_normal notalone" style="position: relative; margin-top: 18px;margin-bottom: 10px; margin-left: 0px;max-height:58px;" src="img/logozap.png" alt="my logo" title="my logo">
					    		
					    		<!-- LOGO RETINA -->				
					    		<img class="logo_retina" style="display:none; position: relative; margin-top: 18px; margin-left: 0px;max-height:58px;" src="img/logo@2x.png" alt="my logo" title="my logo">
					    	</a>
					    </h1>
					    
						<!-- BEGIN: SLOGAN -->		
						<div class="slogan" style="background: none;font-size: 12px;color: #;margin-top: 30px;">Multi-Purpose Wordpress Theme</div>
		    	</div>
